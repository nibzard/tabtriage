...
export default function DirectFolderTest() {
  ...
  const handleDirectTest = async () => {
    try {
      ...
      // Create a test folder with a hardcoded UUID
      const folderId = '98765432-5678-4321-abcd-1234567890ab'
      ...
      console.log('Folder inserted successfully:', data)
      ...
      console.error('Error in direct folder test:', error)
      setResult({
        success: false,
  ...
  return (
    <div className="mt-8 p-4 bg-white rounded-lg shadow">
      <h2 className="text-lg font-semibold mb-4">Direct Folder Test</h2>
      ...
      >
        {loading ? 'Testing...' : 'Create Test Folder'}
      </button>
